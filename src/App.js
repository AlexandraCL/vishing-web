            ...
            cards.map((c, i) => ( <
                    ...
                    p style = {
                        ...
                        c.count !== undefined && < p style = {
                            ...
                            div style = {
                                { background: c.color, color: C.blanco, borderRadius: 12, padding: "10px 18px", textAlign: "center", fontSize: 14, fontWeight: 600 } } > { c.btn }→ <
                            /div> <
                            /div>
                    ))
            } <
                ...
                cards.map((c, i) => ( <
                        ...
                        p style = {
                            ...
                            c.count !== undefined && < p style = {
                                ...
                                div style = {
                                    { background: c.color, color: C.blanco, borderRadius: 10, padding: "8px 14px", display: "inline-block", fontSize: 13, fontWeight: 600 } } > { c.btn }→ <
                                /div> <
                                /div>
                        ))
                } <
        ...
        function Monitoreo({ onGuardar, mobile }) {
            ...
            const toggleGrabacion = () => {
                if (!grabando) { setGrabando(true);
                    ...
                    setTranscripcion("");
                    setPalabras([]);
                    setError(""); } else { setGrabando(false);
                    clearTimeout(loopRef.current); if (mediaRecorderRef.current && mediaRecorderRef.current.state === "recording") mediaRecorderRef.current.stop(); }
            };
            ...
            return ( <
                    ...
                    /div> {
                        error && < div style = {
                                { margin: "0 16px 12px", padding: "12px 16px", background: "rgba(229,57,53,0.15)", borderRadius: 12, border: "1px solid rgba(229,57,53,0.3)", color: "#ff8a80", fontSize: 13 } } > { error } < /div>} <
                            div style = {
                        ...
                        /> {
                            cargando && < p style = {
                                    ...
                                    riesgo >= 75 && < div style = {
                                            { marginTop: 12, padding: "10px 14px", borderRadius: 12, background: "rgba(229,57,53,0.15)", border: "1px solid rgba(229,57,53,0.3)", textAlign: "center", color: "#ff8a80", fontWeight: 700, fontSize: 13 } } > ⚠️Alto riesgo de vishing detectado < /div>} <
                                        /div> {
                                            (transcripcion || palabras.length > 0) && ( <
                                                ...
                                                <
                                                p style = {
                                                    { fontWeight: 700, fontSize: 15, color: C.blanco, marginBottom: 10 } } > Palabras clave detectadas < /p> <
                                                div style = {
                                                    { display: "flex", flexWrap: "wrap", gap: 8, marginBottom: transcripcion ? 14 : 0 } } > {
                                                    palabras.map((w, i) => < span key = { i }
                                                        style = {
                                                            { background: "rgba(255,112,67,0.2)", color: "#ffab91", borderRadius: 8, padding: "4px 10px", fontSize: 13, fontWeight: 600 } } > { w } < /span>)} <
                                                        /div> {
                                            ...
                                            function Configuracion({ config, onChange, mobile }) {
                                                ...
                                                return ( <
                                                    ...
                                                    /div> {
                                                        items.map(item => ( <
                                                            ...
                                                            <
                                                            div style = {
                                                                { width: 44, height: 44, borderRadius: 12, flexShrink: 0, background: `${item.color}22`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20 } } > { item.icon } < /div> <
                                                            p style = {
                                                ...
                                                export default function App() {
                                                    ...
                                                    return ( <
                                                        ...
                                                        <
                                                        div style = {
                                                            { paddingBottom: mobile ? 72 : 0 } } > { renderContenido() } <
                                                        /div>
                                                                ...
                                                                mobile && pantalla === "configuracion" && ( <
                                                                    button onClick = {
                                                                        () => { setPantalla("main");
                                                                            setNavActiva("inicio"); } }
                                                                    style = {
                                                                        { position: "fixed", top: 16, left: 16, background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 12, color: C.blanco, fontSize: 14, fontWeight: 600, cursor: "pointer", padding: "8px 14px" } } > ←Atrás < /button>
                                                                )
                                                            } <
                                                            /div> <
                                                            />
